  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display tracking-wide",
  {
    variants: {
      variant: {
        ...
        neon: "bg-transparent border-2 border-primary text-primary hover:bg-primary/10 hover:shadow-[0_0_25px_hsl(var(--primary)/0.5),inset_0_0_25px_hsl(var(--primary)/0.1)]",
        neonPink: "bg-transparent border-2 border-secondary text-secondary hover:bg-secondary/10 hover:shadow-[0_0_25px_hsl(var(--secondary)/0.5),inset_0_0_25px_hsl(var(--secondary)/0.1)]",
        game: "bg-gradient-to-r from-primary to-accent text-background font-bold hover:shadow-[0_0_30px_hsl(var(--primary)/0.6)] hover:scale-105",
      },
      size: {
